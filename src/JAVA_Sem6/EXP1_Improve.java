...
public class EXP1_Improve {
    public static void main(String[] args) {
        ...
        Employee[] employees = {
                new Employee("1001", "Ashish", "R&D", "1/04/2009", 20000, 8000, 3000, 'e'),
                new Employee("1002", "Sushma", "PM", "23/08/2012", 30000, 12000, 9000, 'c'),
                new Employee("1003", "Rahul", "Acct", "12/11/2008", 10000, 8000, 1000, 'k'),
                new Employee("1004", "Chahat", "Front Desk", "29/01/2013", 12000, 6000, 2000, 'r'),
                new Employee("1005", "Ranjan", "Engg", "16/07/2005", 50000, 20000, 20000, 'm'),
                new Employee("1006", "Suman", "Manufacturing", "1/01/2000", 23000, 9000, 4400, 'e'),
                new Employee("1007", "Tanmay", "PM", "12/06/2006", 29000, 12000, 10000,'c'),
        ...
        Employee selectedEmployee = employees[pos];
